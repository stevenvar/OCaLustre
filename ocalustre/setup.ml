...
(* OASIS_START *)
(* DO NOT EDIT (digest: 04c4d2c3b00e048935f2dd450605294a) *)
(*
...
let setup_t =
  {
          ...
          uninstall_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("$ocamlfind", ["remove"; "ppx_lustre"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          clean_custom =
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ppx_lustre.ml"});
               Test
                 ({
     ...
     oasis_version = "0.4.6";
     oasis_digest =
       Some "\251\131\170\169t\227\130\029\191\151a\229\181\199\196\027";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
