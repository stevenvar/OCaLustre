...
(* OASIS_START *)
(* DO NOT EDIT (digest: b1dd993eeabacbd63bebb058715b79af) *)
(*
...
let setup_t =
  {
          ...
          install_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some
                        (("$ocamlfind", ["install"; "ocalustre"; "lib/META"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          uninstall_custom =
            {
               pre_command =
                 [
                    (OASISExpr.EBool true,
                      Some (("$ocamlfind", ["remove"; "ocalustre"])))
                 ];
               post_command = [(OASISExpr.EBool true, None)]
            };
          clean_custom =
            ...
            [
               Executable
                 ({
                   ...
                   {exec_custom = false; exec_main_is = "ocalustre.ml"});
               Test
                 ({
                     cs_name = "test_ppx_proto";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\142\242k\130.(\014\165kD\193F\159\166\232a";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
